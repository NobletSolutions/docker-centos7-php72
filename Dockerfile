...
RUN yum install -y git php72 php72-php-gd php72-php-intl php72-php-tidy php72-php-pdo php72-php-cli php72-php-process php72-php-xml php72-php-mysql php72-php-mbstring php72-php-bcmath php72-php-pecl-imagick php72-php-pecl-zip 
RUN yum update -y
