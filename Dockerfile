...
RUN yum install -y git php php-syspaths php-gd php-intl php-tidy php-pdo php-cli php-process php-xml php-mysql php-mbstring php-bcmath php-php-pecl-imagick php-php-pecl-zip which && yum update -y && rm -rf /var/cache/yum/* && echo 'date.timezone=America/Edmonton' > /etc/php.d/00-docker-php-date-timezone.ini
